...
public class KingRule extends PieceRule {
    ...
    public Collection<ChessMove> getPossibleMoves(ChessBoard board, ChessPosition position) {
        ...
        if (position.getRow() > 0 && position.getColumn() > 0) {
            if (board.getPiece(new ChessPosition(position.getRow(), position.getColumn())) == null || !board.getPiece(new ChessPosition(position.getRow(), position.getColumn())).getTeamColor().equals(teamColor)) {
        ...
        if (position.getRow() < 7 && position.getColumn() < 7) {
            if (board.getPiece(new ChessPosition(position.getRow()+2, position.getColumn()+2)) == null || !board.getPiece(new ChessPosition(position.getRow()+2, position.getColumn()+2)).getTeamColor().equals(teamColor)) {
        ...
        if (position.getRow() > 0 && position.getColumn() < 7) {
            if (board.getPiece(new ChessPosition(position.getRow(), position.getColumn()+2)) == null || !board.getPiece(new ChessPosition(position.getRow(), position.getColumn()+2)).getTeamColor().equals(teamColor)) {
        ...
        if (position.getRow() < 7 && position.getColumn() > 0) {
            if (board.getPiece(new ChessPosition(position.getRow()+2, position.getColumn())) == null || !board.getPiece(new ChessPosition(position.getRow()+2, position.getColumn())).getTeamColor().equals(teamColor)) {
